...
public class BinaryTree {
	 ...
	 */
	private static int height(BinaryTreeNode<Integer> node, int height) {
		if (node == null) {
			return height;
		}
	 ...
	 * 二叉搜索树 - 查找
	 */
	private BinaryTreeNode<Integer> find(Integer target) {
		if (tree == null) {
			return null;
		}
	...
	private void delete(Integer target) {
		BinaryTreeNode<Integer> p = tree;
		BinaryTreeNode<Integer> pp = null;
		...
		if (p.left != null && p.right != null) {
			BinaryTreeNode<Integer> minP = p.right;
			BinaryTreeNode<Integer> minPP = p;
