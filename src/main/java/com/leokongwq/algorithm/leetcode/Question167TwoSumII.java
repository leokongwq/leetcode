...
public class Question167TwoSumII {
    ...
    /**
     * Given an array of integers that is already sorted in ascending order, find two numbers such that they put up to a specific target number.
     *
     * The function twoSum should return indices of the two numbers such that they put up to the target, where index1 must be less than index2.
     *
     * Note:
     *
